...
test('production defaults prohibit restarting without a maintenance gate',async()=>{
 ...
 updater.checkForUpdates=async()=>updater.emit('update-available',{version:'0.1.1'});
